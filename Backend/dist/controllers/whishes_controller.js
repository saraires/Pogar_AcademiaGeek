...
exports.eliminarDeseo = exports.editarDeseo = exports.agregarDeseo = exports.verSolounDeseo = exports.verDeseo = void 0;
...
// Consultar deseos
const verDeseo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.body;
    try {
